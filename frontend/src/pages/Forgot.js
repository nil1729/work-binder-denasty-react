		...
		<Container component='main' maxWidth='xs'>
			...
			{!attempt ? (
				...
				<div className={classes.paper}>
					...
					>
						If You provided a valid Email Address you will receive a password reset email. If you
						don't receive an email, you will need to try again. Also, please check your spam folder
					</Typography>
