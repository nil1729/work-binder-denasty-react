...
function Trade() {
	...
	const goToSelectionPage = () => {
		let chosen_league_format = selectedTab === 1 ? 'STANDARD' : 'SF-TE-PREMIUM';
		history.push(
			`/select_players?league_size=12&scoring_settings=PPR&league_format=${chosen_league_format}&trade_type=NORMAL&league_type=DYNASTY`
		);
	};
	...
	return (
		<div className={styles.container}>
			<div className={styles.wrapper}>
				...
				<div
					className={`${styles.tab_btn_container} ${size === true ? styles.tab_active : ''}`}
			...
			<div className={styles.wrapper}>
				...
				<div
					className={`${styles.tab_btn_container} ${settings === true ? styles.tab_active : ''}`}
			...
			<div className={styles.wrapper}>
				...
				<div
					className={`${styles.tab_btn_container} ${trade === true ? styles.tab_active : ''}`}
			...
			<div className={styles.wrapper}>
				...
				<div
					className={`${styles.tab_btn_container} ${type === true ? styles.tab_active : ''}`}
			...
			{size && settings && format && trade && type && (
				<button className={styles.btn} onClick={goToSelectionPage}>
					Next
				</button>
			)}
		</div>
